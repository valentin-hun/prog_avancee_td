...
urlpatterns = [
    ...
    path("produit/<pk>/delete/",views.ProduitDelete, name="dlt_prdt"),
    ...
    path("categorie/",views.CategorieCreate, name="crt-cat"),
    path("categorie/<pk>/update/",views.CategorieUpdate, name="cat-chng"),
    path("categorie/<pk>/delete/",views.CategorieDelete, name="dlt_cat"),

    path('statuts/',views.StatutListView.as_view(), name='lst_stats'),
    path("statut/<pk>/",views.StatutDetailView.as_view(), name="dtl_stat"),
    path("statut/",views.StatutCreate, name="crt-stat"),
    path("statut/<pk>/update/",views.StatutUpdate, name="stat-chng"),
    path("statut/<pk>/delete/",views.StatutDelete, name="dlt_stat"),
